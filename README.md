...
1. Easier way to auto Layout, right now its seems like a lot of work
...
<img src='https://i.imgur.com/FPL27lW.gif' title='Yelp Demo' width=332'' alt='Yelp Demo' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

Was not sure how to fully use the Search feature.  I was able to get the Search Bar into the Navigation Bar but I was not able to implement updating the results based on what was on the text field.
